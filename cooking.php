	...
	<div id="conteudocentral">
		<div id="about" class="about sobre">
			...
			<div class="container" >
				...
				$sql ="SELECT * FROM tb_postagens WHERE exibir='1' AND pagina_id = '3' ORDER BY id DESC LIMIT $inicio, $quantidade";
				...
				try{
					...
					<?php
					$sql = "SELECT * from tb_postagens WHERE exibir='1' AND pagina_id = '3'";
					try{
					...
					if($pg>$paginas){echo '<script language= "JavaScript">location.href="cooking.php";</script>';}
					...
					<div class="paginas">
						...
						<a href="index.php?acao=cooking&pg">Primeira Página</a>
					    ...
					    <a href="index.php?acao=cooking&pg=<?php echo $i;?>"  class="ativo<?php echo $i;?>"><?php echo $i;?></a>
					...
					?>
						...
						<a href="index.php?acao=cooking&pg=<?php echo $i;?>" class="ativo"><?php echo $i;?></a>
					...
					<a href="index.php?acao=cooking&pg=<?php echo $paginas;?>">Última página</a>
